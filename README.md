...
| Интерфейс                                                                                                                         | Поведение                                                                            |
|-----------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| ![Пример интерфейса](img/Screenshot_one.png)![Пример карточек](https://via.placeholder.com/300x500/e0e0e0/000000?text=Cards+List) | Карточки с аватаром, именем, профессией, двумя кнопками управления (`+`/`–`) и счётчиком |

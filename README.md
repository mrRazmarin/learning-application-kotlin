...
- ✅ **LazyColumn** — эффективная вертикальная прокрутка для списка карточек/элементов
- ✅ **LazyRow** - эффективная горизонтальная прокрутка для списка карточек/элементов
...
- ✅ Отображение и сокрытие элемента по клику на триггер(кнопку)

---

<details>
<summary markdown="block" style="font-weight:600; margin:16px 0 8px; cursor:pointer;">
   📸 Скриншоты
</summary>
...
| ![Gif-LazyRow](img/lazyrow.gif)              | Карточки с аватаром, именем, профессией обернутыми в LazyRow                       |
|![Gif-expand_text](img/expand_text.gif) | Карточка с аватаром, именем и списком специальностей, которые появляются и скрываются по нажатию кнопки |
</details>
